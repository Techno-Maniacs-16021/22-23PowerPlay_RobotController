...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.86; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 3.68; // in; offset of the lateral wheel
