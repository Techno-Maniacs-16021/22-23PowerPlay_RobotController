...
/////////////////////////////////////////////////////
        ...
        while (opModeIsActive()) {
            ...
            vTarget=3500;
            while (opModeIsActive()&&(Math.abs(vTarget-(vertical_slides.getCurrentPosition()))>7)){
                ////////////////////////VERTICAL SLIDES PID//////////
            ...
            hTarget=1950;
            while(opModeIsActive()&&Math.abs(hTarget-horizontal_slides.getCurrentPosition())>7){
