...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 0.99502487562; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.00446428571; // Multiplier in the Y direction
